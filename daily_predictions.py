...
league_name = "Atzige Hertha Atzen"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 25_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2025-10-25"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
email = os.getenv("forgame20022002@gmail.com")         # Email to send recommendations to, can be the same as EMAIL_USER or different
